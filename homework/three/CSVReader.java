...
public class CSVReader{
	...
	public static void writeCSV(String filePath, IPAddress[] sortedAddress) {
		//final String FILE_HEADER = "START IP,END IP,COUNTRY CODE,COUNTRY,REGION,CITY";
        final String NEW_LINE_SEPARATOR = "\n";
        final String COMMA_DELIMITER = ",";
        final String FILE_PATH = "C:\\Users\\Dario Susic\\Desktop\\IP-COUNTRY-REGION-CITY-SORTED.csv";
